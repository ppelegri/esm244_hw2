...
- UNDERSTAND WHY MEAN DOTS ARE CHANGING IN SIZE AND SEE IF I CAN FIX
...
explore2 <- ggplot(data = palmetto, aes(x = species, y = height, fill = species)) + geom_beeswarm(scale = "count", color = "black") + 
geom_violin(color = "black", fill = NA, width = 0.1, outlier.color = NA) + 
...
explore3 <- ggplot(data = palmetto, aes(x = species, y = length, fill = species)) + geom_beeswarm(scale = "count", color = "black") + 
geom_violin(color = "black", fill = NA, width = 0.1, outlier.color = NA) +
  stat_summary(fun=mean, 
               geom="point", 
               shape=20, 
...
explore4 <- ggplot(data = palmetto, aes(x = species, y = width, fill = species)) + geom_beeswarm(scale = "count", color = "black") + 
geom_violin(color = "black", fill = NA, width = 0.1, outlier.color = NA) + 
  stat_summary(fun=mean, 
               shape=20, 
               size=4, 
...
```{r}
### PLACEHOLDER… I think I can delete
