...
AICc results show that Model 1 (AICc of `r round(palmetto_AICc$AICc[1], 1)`) outperforms Model 2 (AICc of `r round(palmetto_AICc$AICc[2], 1)`) by approximately `r round(palmetto_AICc$Delta_AICc[2], 1)` points. This difference is very large - much larger than the significant difference threshold of 2 points. AICc confirms that Model 1 is preferable to Model 2.
